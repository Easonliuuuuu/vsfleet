...
unchanged observations. <kbd>n</kbd> captures the vCenter in scope — every
vCenter shown when the all-vCenters view (<kbd>a</kbd>) is on — from any of the
three panes. In Runs, <kbd>e</kbd> edits a label, <kbd>N</kbd> edits a
