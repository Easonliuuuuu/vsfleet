...
func TestReadinessVerdicts(t *testing.T) {
	base := Report{SchemaVersion: ReportSchemaVersion, RunID: 7, Rules: []RuleStatus{{Rule: "cdrom-connected", Status: "evaluated", Result: "pass"}, {Rule: "cluster-network-inconsistent", Status: "evaluated", Result: "pass"}, {Rule: "usb-connected", Status: "evaluated", Result: "pass"}}, Coverage: Coverage{Contexts: 1, CompleteContexts: 1}}
