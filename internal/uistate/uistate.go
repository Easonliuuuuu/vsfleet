...
// vctui a second time picks up where the last session left off.
//
...
const EnvStatePath = "VCTUI_STATE"
...
// DefaultPath returns the state file path, honouring VCTUI_STATE and then the
...
func DefaultPath() (string, error) {
	...
	return filepath.Join(dir, "vctui", "state.json"), nil
}
